...
class MainPageControllerTests {
    ...
    @Test
    public void accessOnlyAuthorisedPageFailTest() throws Exception {
    ...
    public void correctLoginTest() throws Exception{
        mockMvc.perform(formLogin("/signin").user("yana@mail.ru").password("123456"))
                .andDo(print())
                .andExpect(status().is3xxRedirection())
    ...
    public void testSearchQuery() throws Exception {
        mockMvc.perform(get("/search/Find"))
                .andDo(print())
